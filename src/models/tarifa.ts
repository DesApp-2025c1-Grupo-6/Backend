...
type TarifaCreationAttributes = Optional<
  TarifaAttributes,
  "id_tarifa" | "createdAt" | "updatedAt" | "deletedAt"
>;

export class Tarifa
  extends BaseModel<TarifaAttributes, TarifaCreationAttributes>
  implements TarifaAttributes
{
